...
from rumi_claude.context.indexers.factory import get_indexer, get_index_inspector
from rumi_claude.llm.factory import get_llm, get_embedder
from langgraph.checkpoint.sqlite.aio import AsyncSqliteSaver
from rumi_claude.agent.factory import build_agent
from rumi_claude.memory.short_term import get_checkpointer_db_path
from rumi_claude.agent.orchestrator import handle_query
from rumi_claude.memory.session import get_current_session, new_session, switch_session
from rumi_claude.cache.semantic_cache import build_semantic_cache, get_repo_domain
from rumi_claude.observability.logger import get_logger

from rumi_claude.tasks.orchestrator import handle_plan_command
from rumi_claude.tasks.status import show_task_status
from rumi_claude.context.indexers.watcher import start_watcher, stop_watcher
...
async def _run_async():
    logger.info("Starting RUMI")
    console.print("\n[bold blue]RUMI[/bold blue] — Lenin's RAG-powered code assistant")
