...
from rumi_claude.tasks.task_store import SQLiteTaskStore
from rumi_claude.tasks.executor import run_subtask_agent
from rumi_claude.tasks.planner import create_plan
from rumi_claude.tasks.approval import present_plan_for_approval
from rumi_claude.tasks.recovery import RecoveryManager
from rumi_claude.context.indexers.factory import get_indexer
...
async def handle_plan_command(goal: str) -> None:
    ...
    """
    db_path = config.get("tasks", {}).get("db_path", ".rumi/tasks.db")
